/-
Code from Chapter 7 (Structures and classes: defining a `Group`) of the
...
-- Chapter 7: a non-abelian example, permutations of Fin 3 (S_3)
...
-- Chapter 7 exercise 1: Bool under xor
