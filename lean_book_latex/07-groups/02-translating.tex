...
A \texttt{GroupData G} is an operation, an identity element, and an inverse function --- no axiom is checked. It can still be nonsense: \texttt{op} could ignore both arguments.
