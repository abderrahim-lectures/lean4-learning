...
\textbf{Mathlib equivalent.} This ``once, free everywhere'' promise is not deferred to a later chapter in Mathlib, which is why the algebra hierarchy is organized around typeclasses at all. The same lemma name applies unchanged to two unrelated groups.
...
\href{https://loogle.lean-lang.org/?q=add_assoc}{\texttt{add\_\allowbreak{}assoc}}/\href{https://loogle.lean-lang.org/?q=mul_assoc}{\texttt{mul\_\allowbreak{}assoc}} were each proved exactly once, generically over \texttt{[AddCommGroup G]}/\texttt{[Group G]}; \texttt{Int} and \texttt{Equiv.Perm (Fin 3)} obtain the fact automatically simply by having the instance. Nothing about either type is re-proved at the call site. This is the library-scale version of the payoff Chapter 8 carries out by hand for \texttt{perm3Group}.
