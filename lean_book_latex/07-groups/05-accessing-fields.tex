...
\textbf{Mathlib equivalent.} No field access to write at all. Once \texttt{Int} is an \href{https://loogle.lean-lang.org/?q=AddCommGroup}{\texttt{AddCommGroup}}, the ordinary \texttt{+}/\texttt{0}/\texttt{-\allowbreak{}} notations already resolve to that instance's operations.
