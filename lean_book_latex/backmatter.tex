...
\texttt{v4.33.1} toolchain, not merely described.
\end{quote}

\vspace{0.8cm}
\begin{center}
{\normalfont\itshape Written by Abderrahim Adrabi, PhD (Faculty of
Sciences, Rabat, and Faculty of Educational Sciences, Rabat, Morocco),
in collaboration with Claude Code.\par}
\end{center}
