...
\subsection{Σ-types: the dependent pair, dual to the Π-type}\label{sec:01-basics:05-pi-sigma-and-coc:4}
...
\subsection{Π-types and Σ-types, side by side}\label{sec:01-basics:05-pi-sigma-and-coc:5}
...
\subsection{Recursors and eliminators, named}\label{sec:01-basics:05-pi-sigma-and-coc:6}
...
\subsection{The calculus of constructions, named}\label{sec:01-basics:05-pi-sigma-and-coc:7}
...
\subsection{Sources, quoted}\label{sec:01-basics:05-pi-sigma-and-coc:8}
