...
This book builds groups, rings, and path algebras \textbf{from scratch}, deliberately, without importing Mathlib (Lean's community math library). This is slower, but better for learning: every definition and every proof obligation is made explicit. Chapter 14 points toward Mathlib for readers ready to use the ``real'' library instead of reinventing it.
