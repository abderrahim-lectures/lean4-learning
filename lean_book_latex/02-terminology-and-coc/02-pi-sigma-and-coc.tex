...
\tightlist
\item
  An infinite hierarchy of type universes \(\mathtt{Type}\,0, \mathtt{Type}\,1, \ldots\), formalized in \hyperref[sec:06-rigor-check:03-typing-rules-and-safety:1]{Chapter 6, Section 3}.
\item
