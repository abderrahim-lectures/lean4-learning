...
\textbf{Claim.} (\cite{DummitFoote2003}, pp.~17-18) \texttt{Grp.inv (Grp.op a b) = Grp.op (Grp.inv b) (Grp.inv a)}.
...
And the same payoff Chapter 8 draws out concretely for \texttt{perm3Group} applies here too, against its own \(S_3\) of Mathlib from Chapter 7, Section 4. There is no new proof, only an application of \texttt{mul\_\allowbreak{}inv\_\allowbreak{}rev} at \texttt{Equiv.Perm (Fin 3)}.
