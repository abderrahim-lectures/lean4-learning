...
\item
  Girard: see \hyperref[sec:06-rigor-check:02-universes:1]{the references of Chapter 6, Section 2} for the full citation. ``Girard's paradox'' (the inconsistency of \texttt{Type : Type}) is due to the 1972 thesis of Girard, a different, later paper than \cite{Girard1971} cited elsewhere in this book.
\item
