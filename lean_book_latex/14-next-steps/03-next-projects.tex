...
\item
  Find \texttt{Prefunctor} in Mathlib (a quiver homomorphism) and, separately, define a \texttt{structure QuiverHom} by hand for two of the own quivers of this book (\texttt{exampleQuiver}, \texttt{cyclicQuiver} from the exercises of Chapter 12), mapping vertices to vertices and arrows to paths.
\item
