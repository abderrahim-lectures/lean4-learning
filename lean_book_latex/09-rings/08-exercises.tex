...
\item
  \emph{The \texttt{mul\_\allowbreak{}assoc} of \texttt{mat2Ring} needed a twelve-line proof; that of \texttt{intRing} needed one. Both are proving associativity. Why such different effort?} \texttt{Int.mul\_\allowbreak{}assoc} is a single already-proved core-library fact to cite. The associativity of matrix multiplication is not a citation away. Each entry of \((XY)Z\) expands to four cross-terms that must be regrouped to match the four cross-terms of \(X(YZ)\), entry by entry. The \emph{content} being proved is bigger, not just the notation.
\item
...
Solutions: \hyperref[sec:15-appendix-solutions:08-chapter-9:1]{Appendix, Chapter 9}.
