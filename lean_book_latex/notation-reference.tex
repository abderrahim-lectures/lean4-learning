...
Group multiplication (the binary operation of a \texttt{Group}) & \(a \cdot b\) & \texttt{op a b} (the \texttt{op} field of \texttt{Group G}) & Chapter 6 \\
Module scalar action (a ring element acting on a module element) & \(r \cdot m\) & \texttt{r • m} (\texttt{SMul}) & Chapter 10 \\
