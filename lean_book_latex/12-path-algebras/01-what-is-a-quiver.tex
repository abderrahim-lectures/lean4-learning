...
A \textbf{quiver} is a \emph{directed graph}: a set of vertices and a set of directed edges (called \textbf{arrows}) between them. This is the same notion \href{https://loogle.lean-lang.org/?q=Quiver}{\texttt{Quiver}} in Mathlib (built here from scratch, following the ``no Mathlib'' policy of Chapter 1, rather than reusing the Mathlib version). Formally, a quiver \(Q\) consists of the following.
