...
The congruence \texttt{congr\_\allowbreak{}example} is the Leibniz principle: \(a = b \Rightarrow f(a) = f(b)\) for any function \(f\) (here \(f(x) = x + 1\)). This is ``substitute equals for equals,'' mechanized. \texttt{rw} is the workhorse for this from here on: nearly every proof from Chapter 4 onward reaches for it whenever an equality hypothesis needs to be used inside a larger goal.
