...
And the same payoff Chapter 7 draws out concretely for \texttt{perm3Group} applies here too, against the own \(S_3\) of Mathlib from Chapter 6, Section 4. There is no new proof, only an application of \texttt{mul\_\allowbreak{}inv\_\allowbreak{}rev} at \texttt{Equiv.Perm (Fin 3)}.
