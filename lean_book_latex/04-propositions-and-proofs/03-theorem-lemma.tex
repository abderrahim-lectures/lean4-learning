...
\subsection{Sources, quoted}\label{sec:04-propositions-and-proofs:03-theorem-lemma:2}

\begin{itemize}
\tightlist
\item
  TPIL4 ``Theorem Declarations'' --- \texttt{theorem} and \texttt{lemma} are syntactically identical in Lean 4.
\end{itemize}
