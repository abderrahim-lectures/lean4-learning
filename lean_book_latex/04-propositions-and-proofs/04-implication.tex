...
Under Curry--Howard (cited in full in Section 1), the implication \(P \Rightarrow
...
\hyperref[sec:04-propositions-and-proofs:03-theorem-lemma:1]{← \texttt{theorem}/\texttt{lemma}} \textbar{} \hyperref[sec:04-propositions-and-proofs:00-index:1]{Index} \textbar{} \hyperref[sec:04-propositions-and-proofs:05-and-or-not:1]{Next: And, Or, Not →}
