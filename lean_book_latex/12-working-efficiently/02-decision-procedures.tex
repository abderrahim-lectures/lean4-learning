...
\begin{quote}
Read more: the Lean/Mathlib documentation for \texttt{decide}, \texttt{omega}, and \texttt{norm\_\allowbreak{}num} (searchable in the Mathlib docs or via \texttt{\#help tactic omega} inside a Lean file) covers each tactic's exact decidable fragment and performance in more depth than this book needs.
\end{quote}
