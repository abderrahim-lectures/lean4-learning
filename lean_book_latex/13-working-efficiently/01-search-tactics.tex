\section{Search tactics: letting Lean find the lemma or the proof}\label{sec:13-working-efficiently:01-search-tactics:1}
...
\item
  \textbf{\href{https://lean-lang.org/doc/reference/latest/Tactic-Proofs/Tactic-Reference/}{\texttt{apply?}}} is like \texttt{exact?}, but for cases where the goal would be closed by \texttt{apply}ing something that leaves further subgoals, not a single exact match.
\end{itemize}
