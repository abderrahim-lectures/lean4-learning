...
This is the same judgment call made when writing ordinary code, extract a helper when, and only when, real duplication or a genuinely separate sub-claim is present, not ahead of time ``just in case.''
