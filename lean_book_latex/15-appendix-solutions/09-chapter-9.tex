\section{Chapter 9: Rings}\label{sec:15-appendix-solutions:09-chapter-9:1}

\textbf{1. \texttt{bool2Ring} (the ring \(\mathbb{Z}/2\mathbb{Z}\) on \texttt{Bool})}
