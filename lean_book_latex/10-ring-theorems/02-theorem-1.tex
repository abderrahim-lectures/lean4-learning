...
\texttt{mul\_\allowbreak{}zero} is the kind of fact a Python codebase would not test --- \texttt{x * 0} is \texttt{0}. It genuinely is, for \texttt{int}. It is not, for every numeric type Python ships.
