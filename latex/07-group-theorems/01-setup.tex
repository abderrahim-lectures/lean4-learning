...
\subsection{Recall}\label{sec:07-group-theorems:01-setup:2}
...
\subsection{References}\label{sec:07-group-theorems:01-setup:3}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), §1.1 ``Basic Axioms and Examples,'' pp.~17--18, Proposition 1 --- uniqueness of identity/inverses, inverse-of-a-product law.
\end{itemize}
