...
\subsection{Recall}\label{sec:05-rigor-check:04-defeq-vs-propeq:2}
...
\subsection{Definitional equality}\label{sec:05-rigor-check:04-defeq-vs-propeq:3}
...
\subsection{Propositional equality}\label{sec:05-rigor-check:04-defeq-vs-propeq:4}
...
\subsection{Why the distinction has real consequences}\label{sec:05-rigor-check:04-defeq-vs-propeq:5}
...
\subsection{A note on proof irrelevance}\label{sec:05-rigor-check:04-defeq-vs-propeq:6}
...
\subsection{A note on structure eta}\label{sec:05-rigor-check:04-defeq-vs-propeq:7}
...
\subsection{References}\label{sec:05-rigor-check:04-defeq-vs-propeq:8}
