...
\tightlist
\item
  Chlipala (\cite{Chlipala2013}), §6.2 ``Decidable Proposition Types'' --- \textbf{Correction:} previously cited as Pierce2002, but TAPL does not discuss \texttt{Decidable} as a type-theoretic notion at all; §6.2 of Chlipala's \emph{Certified Programming with Dependent Types} is the actual source for this notion (a type witnessing that a proposition's truth value is computable), the formal counterpart of the informal definition above.
\end{itemize}
