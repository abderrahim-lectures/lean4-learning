...
\subsection{Recall}\label{sec:10-modules:06-direct-sums:2}
...
\subsection{\texorpdfstring{A concrete instance: \(\mathbb{Z} \oplus \mathbb{Z}\)}{A concrete instance: \textbackslash mathbb\{Z\} \textbackslash oplus \textbackslash mathbb\{Z\}}}\label{sec:10-modules:06-direct-sums:3}
...
\subsection{References}\label{sec:10-modules:06-direct-sums:4}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), §10.3 ``Generation of Modules, Direct Sums, and Free Modules,'' pp.~351--353, Proposition 5 --- direct sums of modules, internal/external direct-sum equivalence.
\end{itemize}
