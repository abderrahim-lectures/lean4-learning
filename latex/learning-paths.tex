...
\textbf{``I want the formal foundations before anything else.''} Read Chapter 1 in full, including Sections 4--5's calculus-of-constructions material, then Chapter 3, Sections 1--2 for the logic recap, then Chapter 5 in full including Section 3's typing rules --- all before touching tactics or groups. This front-loads everything Chapters 6 onward take for granted, at the cost of deferring concrete payoff the longest.
