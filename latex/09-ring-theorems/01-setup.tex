...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}) --- the standard classical (non-Lean) reference for the two theorems this chapter formalizes (\(a \cdot 0 = 0\) and the sign rule), both standard early consequences of the ring axioms.
\end{itemize}
