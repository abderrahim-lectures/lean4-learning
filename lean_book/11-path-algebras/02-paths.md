...
- Schiffler ([Schiffler2014]), **Definition 2.1 and Example 2.2** (Chapter 2, §2.1) covers the same notion, called the "constant path" (or "lazy path") $e_i$ at vertex $i$ for the length-$0$ case.
