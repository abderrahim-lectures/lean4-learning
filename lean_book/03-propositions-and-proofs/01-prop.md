...
matching projection). This is why the tactics of Chapter 4, which *build*
proof terms, and the discussion of reduction and definitional
equality in Chapter 5, are really talking about one and the same underlying process,
...
> The progress
> and preservation theorems of [Chapter 5, Section 3](../05-rigor-check/03-typing-rules-and-safety.md) are the formal statement of "a proof never
