...
by Chapter 6, since the dependency structure only really branches in Part I.

## Chapter dependency graph

```mermaid
graph TD
    C0["0. Setup"] --> C1a["1. Basics Sections 1-3"]
    C1a --> C1b["1. Basics Sections 4-5"]
...
confirm your toolchain matches `v4.32.2`), read Chapter 1, Sections 1–3 for the
specific `Fin`/`Vec` examples of this book, skip Sections 4–5 and Chapter 5 entirely
unless something later sends you back (the [Chapter 1, Section 4
...
if a term is unfamiliar), then read Chapters 2–4 quickly for the own
conventions of the book before Chapters 6–13 in full.
...
in full, including the calculus-of-constructions material of Sections 4–5, then
Chapter 3, Sections 1–2 for the logic recap, then Chapter 5 in full including
the typing rules of Section 3, all before touching tactics or groups. This front-loads
...
Chapter 0, Section 1 ("Why Lean?"), then jump straight to Chapters 6–7 (`Group`),
referring back to Chapters 1–5 only when a specific term or tactic is
unfamiliar (the [Chapter 1, Section 4 glossary](01-basics/04-terminology.md) and
