...
This notebook is a companion to the Lean material, not a substitute for
it. Each snippet illustrates a specific point the book makes about the
type system of Lean; the full explanation is in the corresponding chapter. To run
the own Lean examples of the book, see
[`lean_project/`](../../lean_project/) instead.
