...
deferred to a later chapter in Mathlib — it is why the algebra hierarchy
...
type is re-proved at the call site — the library-scale version of the
payoff Chapter 8 carries out by hand for `perm3Group`.
