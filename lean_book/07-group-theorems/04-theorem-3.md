...
immediately to `perm3Group` (the non-abelian permutation group of Chapter 6),
...
here too, against the own $S_3$ of Mathlib from Chapter 6, Section 4. There is no new
