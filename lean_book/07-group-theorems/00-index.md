...
[← Ch. 6: Groups](../06-groups/00-index.md) | [Table of contents](../README.md) | [Ch. 8: Rings →](../08-rings/00-index.md)
...
2. **What is the first fact worth proving this way?**
   ...
   first because its proof introduces the central technique of the chapter:
...
4. **Having just proved *that* a left inverse is unique, can that fact
   ...
   $b^{-1}a^{-1}$ satisfies the characterizing equation of Theorem 2, a
   "compute this" goal turned into a cheaper "verify this" goal, and the
   result is then applied, with no new proof, to the concrete
   permutation group of Chapter 6, delivering the "proved once, free everywhere"
   promise for real.
