...
- **A Markdown nested-emphasis bug**: two questions wrapped their entire
  ...
  places (`06-rigor-check/05-exercises.md`, `07-groups/07-exercises.md`).
...
- Cross-chapter references (`[Chapter 5 §2](../06-rigor-check/...)`)
...
- Added a brief **"Key points"** recap immediately before each chapter's
  ...
  13 was left without one, since [01-what-we-built.md](../14-next-steps/01-what-we-built.md)
...
- Added a new **checkpoint project** at the end of Part I,
  [06-rigor-check/06-checkpoint-project.md](../06-rigor-check/06-checkpoint-project.md):
  ...
  [Appendix, Chapter 5](../15-appendix-solutions/05-chapter-5.md).
- Added a second **checkpoint project** at the end of Part II,
  [12-path-algebras/07-checkpoint-project.md](../12-path-algebras/07-checkpoint-project.md):
  ...
  [Appendix, Chapter 11](../15-appendix-solutions/11-chapter-11.md); [Chapter
  13's "What we built"](../14-next-steps/01-what-we-built.md) updated to name
...
- Both new chapters' `00-index.md` and their exercises files' navigation
  ...
  section.
- Expanded [Chapter 13 §3](../14-next-steps/03-next-projects.md)'s five
...
- **Wrong lemma name in a solution.** [Appendix, Chapter
  5](../15-appendix-solutions/05-chapter-5.md)'s exercise 1 solution claimed
...
- **A tool-output claim that didn't match the real toolchain.** [Chapter 12
  §1](../13-working-efficiently/01-search-tactics.md) claimed `exact?` suggests
...
- **A missing exercise solution.** [Appendix, Chapter
  8](../15-appendix-solutions/08-chapter-8.md) had solutions for exercises 1–2
...
- **Repeated chapter mislabeling.** [Chapter
  12](../13-working-efficiently/00-index.md) attributed the "find the proof
...
- **A stale cross-reference.** [Chapter 10 §5](../11-modules/05-linear-maps.md)
...
- **An overclaim about the book's own tactic usage.** [Chapter
  13](../14-next-steps/01-what-we-built.md) claimed "there is no `simp`"
  anywhere in the book; [Chapter 6 §4](../07-groups/04-permutations-example.md)'s
...
- Added **References** sections (real, verified sources) to chapters that
  ...
  2](../03-functions-and-structures/01-structure-basics.md) (structure-as-product,
  parametric polymorphism, forgetful functors), [Chapter
  8 §3](../09-rings/03-ring.md) (Dummit & Foote, Aluffi), [Chapter 10
  §2](../11-modules/02-translating-into-lean.md) (Dummit & Foote, Weibel), and
  [Chapter 11 §5](../12-path-algebras/05-path-composition.md)
...
- Ran a full site-wide Markdown link-integrity sweep; the only unresolved
  ...
  this changelog (see above, "10-chapter-11.md" predates the Appendix B
  renumbering).
...
- **Eliminated Appendix B entirely**, merging its ~9,000 words of formal
  ...
  - The standard-logic recap (natural deduction, soundness/completeness,
    ...
    §2](../04-propositions-and-proofs/02-logic-recap.md), immediately after
  ...
  - The untyped λ-calculus recap (grammar, α/β-reduction, currying,
    ...
    §4](../02-terminology-and-coc/01-terminology.md)'s "Reduce/reduction" glossary entry.
  - Π-types, `Prop` irrelevance, Σ-types, and the CoC/CIC summary are now
    [Chapter 1 §5](../02-terminology-and-coc/02-pi-sigma-and-coc.md); the simply typed
    λ-calculus's typing judgments/progress/preservation and the
    universe-formation typing rule are now a new [Chapter 5
    §3](../06-rigor-check/03-typing-rules-and-safety.md), extending §2's
    informal universe discussion.
  - Church encodings (booleans, numerals) became a self-contained aside
    in [Chapter 13](../14-next-steps/03-next-projects.md), since nothing
  ...
  - Added a new Chapter 1 exercises section
    ([01-basics/06-exercises.md](../01-basics/04-exercises.md)) with
