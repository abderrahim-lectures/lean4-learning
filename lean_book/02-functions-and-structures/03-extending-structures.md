...
- The [Lean 4 documentation on `structure` extension](https://lean-lang.org/doc/reference/latest/) — the auto-generated `.toX` projection produced by `extends`, used above as `origin3D.x` and `.toPoint`.
- nLab, ["forgetful functor"](https://ncatlab.org/nlab/show/forgetful+functor) — the categorical reading of the `.toPoint`/`.toGroup` projection generated by `extends`.
