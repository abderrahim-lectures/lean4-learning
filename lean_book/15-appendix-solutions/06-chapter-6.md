...
[← Chapter 5](05-chapter-5.md) | [Index](00-index.md) | [Next: Chapter 7 →](07-chapter-7.md)
...
definition (this is the same asymmetry Chapter 5 relied on for
...
`intGroup : Group Int` `def` from Chapter 7. Registering something as an
...
(Chapter 7, Section 3) minus the two inverse fields, each proof obligation is a
...
one). The proof of `monoid_id_unique` is `id_unique` (Chapter 8, Theorem 1) copied
...
"prove once, get it for free" payoff Chapter 7, Section 6 promises for `Group`.
