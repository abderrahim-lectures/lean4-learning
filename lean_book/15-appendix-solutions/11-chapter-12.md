## Chapter 13: Quivers and path algebras

[← Chapter 12](10-chapter-11.md) | [Index](00-index.md)
...
acyclicity (see the finiteness discussion of Chapter 13) inconsistent.
...
-- To satisfy `Ring` (Chapter 10), `PathAlgebraElem` would need:
...
in Chapter 8, Section 4, with core Lean lacking a `structure`
extensionality lemma, now met again with indexed recursion instead.

---

[← Chapter 12](10-chapter-11.md) | [Index](00-index.md) | [Table of contents](../README.md)
