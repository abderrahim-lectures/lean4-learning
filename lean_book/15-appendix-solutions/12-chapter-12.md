...
[← Chapter 11](11-chapter-11.md) | [Index](00-index.md)
...
acyclicity (see the finiteness discussion of Chapter 12) inconsistent.
...
-- To satisfy `Ring` (Chapter 9), `PathAlgebraElem` would need:
...
in Chapter 7, Section 4, with core Lean lacking a `structure`
extensionality lemma, now met again with indexed recursion instead.

---

[← Chapter 11](11-chapter-11.md) | [Index](00-index.md) | [Table of contents](../README.md)
