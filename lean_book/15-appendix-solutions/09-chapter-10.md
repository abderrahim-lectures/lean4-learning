## Chapter 11: Ring examples and basic theorems

[← Chapter 10](08-chapter-9.md) | [Index](00-index.md) | [Next: Chapter 12 →](10-chapter-11.md)
...
By `left_inverse_unique` (Chapter 9, Theorem 2, applied to the additive
...
`intRing.addGrp.toGroup.inv` unfolds (by the `def intGroup` from Chapter 8)
...
Chapter 7 draws between definitional and propositional equality.
