...
[← Chapter 9](09-chapter-9.md) | [Index](00-index.md) | [Next: Chapter 11 →](11-chapter-11.md)
...
By `left_inverse_unique` (Chapter 8, Theorem 2, applied to the additive
...
`intRing.addGrp.toGroup.inv` unfolds (by the `def intGroup` from Chapter 7)
...
Chapter 6 draws between definitional and propositional equality.
