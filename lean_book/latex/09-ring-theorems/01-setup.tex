...
\subsection{Recall}\label{sec:09-ring-theorems:01-setup:2}
...
\subsection{References}\label{sec:09-ring-theorems:01-setup:3}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), §7.1 ``Basic Definitions and Examples,'' p.~225, Proposition 1 --- \(a \cdot 0 = 0\) and the sign rule.
\end{itemize}
