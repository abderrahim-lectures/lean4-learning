...
% Lean's keyword/tactic lists and comment syntax are carried over directly
% from build/lean4.xml (the Kate syntax definition used by the PDF-build
% pipeline), adapted to `listings`' simpler (non-context-sensitive) model.
