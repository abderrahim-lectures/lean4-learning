...
\item
  Milner (\cite{Milner1978}) --- the theoretical account of parametric polymorphism that \texttt{TypeVar}, and Lean's \texttt{\textbackslash{}\{α : Type\textbackslash{}\} → ...}, both implement to different degrees.
\end{itemize}
