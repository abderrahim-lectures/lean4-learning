...
\subsection{Recall}\label{sec:02-functions-and-structures:01-structure-basics:0b}
...
\tightlist
\item
  \textbf{Record / tuple.} ``The simplest of these is pairs, or more generally tuples, of values ... the generalization from n-ary tuples to labeled records is equally straightforward'' (\cite{Pierce2002}, §11.6--§11.8). Brief: \texttt{structure} is this book's realization of a labeled record.
\item
