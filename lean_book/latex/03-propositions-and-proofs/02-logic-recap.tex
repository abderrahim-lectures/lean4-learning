...
\subsection{Recall}\label{sec:03-propositions-and-proofs:02-logic-recap:0b}
...
\item
  \textbf{Soundness.} ``\(\Gamma \vdash \varphi \Rightarrow \Gamma \models \varphi\)'' (\cite{VanDalen2013}, §2.5, Lemma 2.5.1). Brief: everything provable is true.
\item
