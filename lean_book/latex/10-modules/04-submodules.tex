...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), \S10.1 ``Basic Definitions and Examples,'' p.~337 --- the standard classical (non-Lean) reference for submodules and their axioms, verified verbatim: ``An $R$-submodule of $M$ is a subgroup $N$ of $M$ which is closed under the action of ring elements, i.e., $rn \in N$, for all $r \in R, n \in N$.''
\end{itemize}
