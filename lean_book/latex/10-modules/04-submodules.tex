...
\subsection{Recall}\label{sec:10-modules:04-submodules:2}
...
\subsection{\texorpdfstring{Example: the submodule of even integers, as a \(\mathbb{Z}\)-submodule of \(\mathbb{Z}\)}{Example: the submodule of even integers, as a \textbackslash mathbb\{Z\}-submodule of \textbackslash mathbb\{Z\}}}\label{sec:10-modules:04-submodules:3}
...
\subsection{References}\label{sec:10-modules:04-submodules:4}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), §10.1 ``Basic Definitions and Examples,'' p.~337 --- submodules and their axioms.
\end{itemize}
