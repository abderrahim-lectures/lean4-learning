...
\subsection{Recall}\label{sec:10-modules:04-submodules:0b}
...
\subsection{References}\label{sec:10-modules:04-submodules:3}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), \S10.1 ``Basic Definitions and Examples,'' p.~337 --- submodules and their axioms.
\end{itemize}
