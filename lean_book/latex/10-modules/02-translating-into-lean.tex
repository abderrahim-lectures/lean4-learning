...
\subsection{Recall}\label{sec:10-modules:02-translating-into-lean:2}
...
\subsection{References}\label{sec:10-modules:02-translating-into-lean:3}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), §10.1 ``Basic Definitions and Examples,'' p.~336 --- module axioms (M1)--(M4).
\item
