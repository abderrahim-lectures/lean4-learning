...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), \S10.1 ``Basic Definitions and Examples,'' p.~336 --- the module axioms (M1)--(M4) from the classical, non-Lean point of view, verified verbatim: ``a binary operation $+$ on $M$ under which $M$ is an abelian group, and... an action of $R$ on $M$... (a) $(r+s)m = rm+sm$... (b) $(rs)m = r(sm)$... (c) $r(m+n) = rm+rn$... (d) $1m = m$.''
\item
