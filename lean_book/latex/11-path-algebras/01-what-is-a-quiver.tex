...
\subsection{References}\label{sec:11-path-algebras:01-what-is-a-quiver:3}
...
\tightlist
\item
  Assem, Simson, and Skowroński (\cite{AssemSimsonSkowronski2006}), \textbf{Definition 1.1} (Chapter II, §1, ``Quivers and path algebras'') --- the standard graduate reference for the quiver definition above, stated there verbatim as \(Q = (Q_0, Q_1, s, t)\).
\item
