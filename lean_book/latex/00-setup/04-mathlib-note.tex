...
\textbf{Key points.} Lean 4 plus \texttt{lake}, an editor with the Lean extension, and a pinned toolchain (matching \texttt{lean\textbackslash{}\_project/lean-toolchain}) are all that is needed to follow along. This book is Mathlib-free by design through Chapter 11's from-scratch constructions; Mathlib appears only in the ``Mathlib equivalent'' boxes from Chapter 6 onward, and in full starting Chapter 13.
