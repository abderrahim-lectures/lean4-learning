...
\item
  All Lean code in this section was checked directly against the toolchain pinned in this repository's \texttt{lean\textbackslash{}\_project/lean-toolchain} rather than only described; the \texttt{\textbackslash{}\#print Fin} output and both error messages shown are copied from real \texttt{lake env lean} runs.
\end{itemize}
