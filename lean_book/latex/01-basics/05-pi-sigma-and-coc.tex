...
\tightlist
\item
  Coquand and Huet (\cite{CoquandHuet1988}) --- the original paper defining CoC, the system this section formalizes, including the inductive-type extension (CIC) that gives rise to recursors/eliminators like \texttt{Nat.rec}.
\item
  Pierce (\cite{Pierce2002}) --- a general treatment of eliminators/case-analysis principles for inductive types in a dependently-typed setting.
\item
