...
\item
  nLab, ``natural numbers object'' (\cite{NLabNNO}) --- the standard name for exactly the construction in the optional box's second paragraph: \texttt{Nat} as the initial algebra for the ``one chosen element plus one self-map'' structure.
\end{itemize}
