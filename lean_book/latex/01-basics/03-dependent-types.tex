...
\item
  The Lean 4 source / {[}Mathlib4 API documentation{]}\cite{Mathlib4Docs} for \texttt{Fin} and \texttt{Vector} --- confirmed directly in this section via \texttt{\textbackslash{}\#print Fin} against the actual toolchain pinned in this repository's \texttt{lean\textbackslash{}\_project/lean-toolchain}.
\item
