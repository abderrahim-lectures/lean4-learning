...
\tightlist
\item
  Chlipala (\cite{Chlipala2013}), §6.2 ``Decidable Proposition Types'' --- the actual source for \texttt{Decidable} as a type-theoretic notion (an earlier draft of this book cited Pierce2002 instead, but TAPL does not discuss \texttt{Decidable} at all).
\end{itemize}
