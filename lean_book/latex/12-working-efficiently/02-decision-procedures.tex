...
\subsection{Recall}\label{sec:12-working-efficiently:02-decision-procedures:0b}
...
\subsection{References}\label{sec:12-working-efficiently:02-decision-procedures:2}
...
\tightlist
\item
  Chlipala (\cite{Chlipala2013}), §6.2 ``Decidable Proposition Types'' --- \textbf{Correction:} previously cited as Pierce2002, but TAPL does not discuss \texttt{Decidable} as a type-theoretic notion at all; §6.2 of Chlipala's \emph{Certified Programming with Dependent Types} is the actual source.
\end{itemize}
