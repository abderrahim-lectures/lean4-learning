...
\tightlist
\item
  Pierce (\cite{Pierce2002}) --- the standard reference for \texttt{Decidable} as a type-theoretic notion (a type witnessing that a proposition's truth value is computable), the formal counterpart of the informal definition above.
\end{itemize}
