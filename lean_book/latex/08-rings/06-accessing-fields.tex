...
The chained projections walk down the tower of

\end{mathreading}

\(\mathbf{Ring} \to \mathbf{Ab} \to \mathbf{Grp}\): \texttt{intRing.addGrp} applies \(\mathbf{Ring}\to\mathbf{Ab}\) (recovering \((\mathbb{Z},
