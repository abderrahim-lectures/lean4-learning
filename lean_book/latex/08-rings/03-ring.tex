...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), \S7.1 ``Basic Definitions and Examples,'' pp.~222--225 --- the standard classical (non-Lean) reference for the ring axioms (R1)--(R4) and their consequences, verified verbatim: ``(i) $(R, +)$ is an abelian group, (ii) $\times$ is associative... (iii) the distributive laws hold'' and, for consequences, ``$0a = a0 = 0$ for all $a \in R$'' (Proposition 1).
\item
