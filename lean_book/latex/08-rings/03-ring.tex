...
\subsection{Recall}\label{sec:08-rings:03-ring:0b}
...
\tightlist
\item
  \textbf{Ring.} ``(i) \((R, +)\) is an abelian group, (ii) \(\times\) is associative ... (iii) the distributive laws hold'' (\cite{DummitFoote2003}, §7.1 ``Basic Definitions and Examples,'' pp.~222--223). A basic consequence: ``\(0a = a0 = 0\) for all \(a \in R\)'' (p.~225, Proposition 1).
\end{itemize}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), \S7.1 ``Basic Definitions and Examples,'' pp.~222--225 --- ring axioms (R1)--(R4) and their consequences.
\item
