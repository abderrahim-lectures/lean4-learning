...
\href{https://loogle.lean-lang.org/?q=mul_add}{\texttt{mul\textbackslash{}\_add}}/\href{https://loogle.lean-lang.org/?q=add_mul}{\texttt{add\textbackslash{}\_mul}} are Mathlib's names for \texttt{left\textbackslash{}\_distrib}/\texttt{right\textbackslash{}\_distrib}. They are the same laws, but stated generically over \texttt{[Ring R]} (or the weaker \texttt{[Distrib R]}) instead of being cited per-type as \texttt{Int.mul\textbackslash{}\_add}/\texttt{Int.add\textbackslash{}\_mul}.
