...
\subsection{References}\label{sec:08-rings:04-integers-example:2}
...
\tightlist
\item
  Dummit and Foote (\cite{DummitFoote2003}), \S7.3 ``Ring Homomorphisms and Quotient Rings,'' p.~239 --- the standard definition of a ring homomorphism, used above, verified verbatim: ``A ring homomorphism is a map $\varphi : R \to S$ satisfying (i) $\varphi(a+b) = \varphi(a)+\varphi(b)$... and (ii) $\varphi(ab) = \varphi(a)\varphi(b)$.''
\end{itemize}
