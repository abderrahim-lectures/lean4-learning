...
β-reduction \((\lambda x.t)s \to t[x:=s]\) & \texttt{rfl}, \texttt{\textbackslash{}\#eval} reduction & Chapter 1 §4, Chapter 5 §4 (definitional equality) \\
type judgment \(\Gamma \vdash t : \tau\) & \texttt{\textbackslash{}\#check t} & Chapter 1 \\
