...
\item
  Verify on paper that \texttt{inv\textbackslash{}\_left} and \texttt{inv\textbackslash{}\_right} are genuinely different obligations. They coincide automatically only once the group has been \emph{proved} commutative --- this is exactly the content of Chapter 7's first theorem.
\end{enumerate}
