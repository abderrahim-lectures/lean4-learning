...
\text{13. Next steps}
\arrow["\text{already know Lean}"{sloped}, dashed, bend right=80, looseness=3, from=2-1, to=4-1]
\arrow["\text{already know Lean}"{sloped}, dashed, bend right=70, looseness=2.5, from=6-1, to=9-1]
\arrow["\text{fastest path}"{sloped}, dashed, bend left=55, looseness=1.8, from=1-1, to=9-1]
\end{tikzcd}
