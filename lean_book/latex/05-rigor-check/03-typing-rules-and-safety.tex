...
\item
  Girard --- see \hyperref[sec:05-rigor-check:02-universes:1]{Section 2's References} for the full citation: ``Girard's paradox'' (the inconsistency of \texttt{Type : Type}) is due to Girard's 1972 thesis, a different, later paper than \cite{Girard1971} cited elsewhere in this book.
\item
