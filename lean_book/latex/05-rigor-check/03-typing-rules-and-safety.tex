...
\item
  Girard --- \textbf{Correction:} see the note in \hyperref[sec:05-rigor-check:02-universes:1]{§2's References} --- ``Girard's paradox'' (the inconsistency of \texttt{Type : Type}) is due to Girard's 1972 thesis, not the 1971 paper cited as \cite{Girard1971} elsewhere in this book.
\item
