...
\tightlist
\item
  Define \texttt{structure Monoid (M : Type) where} with fields \texttt{op}, \texttt{id}, and proof obligations \texttt{assoc}, \texttt{id\_\allowbreak{}left}, \texttt{id\_\allowbreak{}right} --- exactly \texttt{Group}'s fields (Chapter 6, Section 2), minus \texttt{inv}/\texttt{inv\_\allowbreak{}left}/\texttt{inv\_\allowbreak{}right}.
\item
