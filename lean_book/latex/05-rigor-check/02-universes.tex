...
\tightlist
\item
  \emph{Theorem Proving in Lean 4} (\cite{TPIL4}), §2.2 ``Types as objects'' --- Lean's own documentation on the universe hierarchy, verified verbatim (``Type 0 as a universe of `small' or `ordinary' types\ldots{} the list is infinite: there is a Type n for every natural number n''), matching the presentation here.
\item
