...
\subsection{Recall}\label{sec:05-rigor-check:02-universes:2}
...
\subsection{The hierarchy}\label{sec:05-rigor-check:02-universes:3}
...
\subsection{\texorpdfstring{Why this matters for \texttt{Group}}{Why this matters for Group}}\label{sec:05-rigor-check:02-universes:4}
...
\subsection{References}\label{sec:05-rigor-check:02-universes:6}
...
\tightlist
\item
  \emph{Theorem Proving in Lean 4} (\cite{TPIL4}), §2.2 ``Types as objects'' --- universe hierarchy, universe polymorphism.
\item
