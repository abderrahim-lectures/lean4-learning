...
\tightlist
\item
  \emph{Theorem Proving in Lean 4} (\cite{TPIL4}), ``Dependent Types'' --- Lean's own documentation on the universe hierarchy, matching the presentation here.
\item
  Girard (\cite{Girard1971}) --- the original source of the paradox this stratified hierarchy is built to avoid (named ``Girard's paradox'' in \hyperref[sec:05-rigor-check:03-typing-rules-and-safety:1]{Chapter 5 §3}).
\end{itemize}
