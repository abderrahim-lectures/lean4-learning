...
\item
  Girard --- \textbf{Correction:} \cite{Girard1971} (the 1971/1970 ``Une extension de l'interprétation de Gödel à l'analyse'' paper) is \emph{not} the source of the \texttt{Type : Type} inconsistency. The proof that a calculus with the rule \texttt{⊢ * : *} loses the normalization property is due to Girard's 1972 doctoral thesis, \emph{``Interprétation fonctionnelle et élimination des coupures dans l'arithmétique d'ordre supérieure,''} Thèse d'État, Université Paris VII, 1972 --- not yet in this book's bibliography. (Thierry Coquand's 1986 paper ``An analysis of Girard's paradox,'' LICS 1986, is the standard modern exposition, also not yet cited here.)
\end{itemize}
