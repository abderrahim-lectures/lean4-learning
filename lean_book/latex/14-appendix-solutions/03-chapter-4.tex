...
\textbf{1. \texttt{theorem and\textbackslash{}\_comm\textbackslash{}\_tac \textbackslash{}\{P Q : Prop\textbackslash{}\} (h : P ∧ Q) : Q ∧ P}}
...
\textbf{2. \texttt{theorem nat\textbackslash{}\_mul\textbackslash{}\_zero (n : Nat) : n * 0 = 0}}
...
\textbf{3. \texttt{modus\textbackslash{}\_ponens} in tactic mode}
