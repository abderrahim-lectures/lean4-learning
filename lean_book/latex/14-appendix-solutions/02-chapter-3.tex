...
\textbf{1. \texttt{theorem and\_comm\_ex \{P Q : Prop\} (h : P ∧ Q) : Q ∧ P}}
...
\textbf{2. \texttt{theorem or\_comm\_ex \{P Q : Prop\} (h : P ∨ Q) : Q ∨ P}}
...
\textbf{3. \texttt{theorem exists\_gt\_zero : ∃ n : Nat, n > 0}}
