...
from Chapter 4 proves a propositional equality that
...
extensionality reasoning of Chapter 8 work, and [`congr 1`](https://lean-lang.org/doc/reference/latest/Tactic-Proofs/Tactic-Reference/) in Chapter 10, which splits a
...
- Pierce ([Pierce2002]), Ch. 3, 11–12 covers operational semantics and reduction, and the general distinction between checking equality by computation versus by proof that this section specializes to `rfl`/`=` in Lean.
