...
is already in hand from Chapters 1–6 alone; nothing here depends on
...
a `structure` (Chapter 3), writing tactic-mode proofs for a genuine
algebraic axiom set (Chapter 5), and building a small "prove it once,
generically" theorem in the style Chapter 8 will use for `Group`, here
done for the weaker `Monoid` first.

**Prerequisites.** Chapters 1–6 only.
...
3. Prove a generic theorem for an arbitrary `Mn : Monoid M`: *the identity
   ...
   `e' = Mn.id`. This is exactly Theorem 1 of Chapter 8 (`id_unique`)
...
-- Chapter 7, Section 6 promises for Group, delivered here one chapter early.
...
[← Exercises](05-exercises.md) | [Index](00-index.md) | [Table of contents](../README.md) | [Ch. 7: Groups →](../07-groups/00-index.md)
